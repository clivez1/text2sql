...
> 状态：持续追加
> 更新：2026-04-18
> 注：本文中的 `10-repository-physical-reorg/`、`20-code-migration/`、`30-capability-topics/` 等路径为历史时期的旧目录名，现已分别迁入 `stage1/01-repository-physical-reorg/`、`stage1/02-code-refactor/`、`references/themes/`。
