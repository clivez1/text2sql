...
## 5. 与 stage1/01-repository-physical-reorg/ 的关系

stage1/01-repository-physical-reorg/ 定义“目标目录应该长什么样”。

本目录定义“旧代码怎样迁到那个目标目录”。

执行时顺序固定为：

1. 先看 stage1/01-repository-physical-reorg/02-app-physical-structure.md 冻结 app 物理落位。
