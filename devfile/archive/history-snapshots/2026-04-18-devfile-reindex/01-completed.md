...
> 说明：本文件主要记录 2026-04-18 之前的历史完成项与基线收口。自 2026-04-18 起，项目已切换到“最终目标方案”主线，新的未来规划不再写入本文件，而由 `00-master-plan.md`、`02-pending.md`、`03-in-progress.md` 与 `11-17` 专项文档承接。
...
- 2026-04-18：已完成 devfile 主线切换，新增最终目标总方案与 `11-17` 专项方案，旧版关键文档已归档到 `archive/history-snapshots/2026-04-18-final-target-baseline/`
- 2026-04-18：已完成 Provider 协议层首轮骨架实现，配置层已支持协议识别，adapter 工厂已支持 OpenAI compatible / Anthropic messages / local gateway，相关单测通过
- 2026-04-18：已完成目标代码目录重构第一步，新增 `presentation / application / domain / infrastructure` 分层骨架，并将目标架构文档从平铺 `app/core` 调整为分层分域结构
