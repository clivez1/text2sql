...
3. 10-repository-physical-reorg/ 已冻结目标目录落位。
4. 20-code-migration/ 已冻结按层迁移和 cutover 规则。
5. 30-capability-topics/ 已冻结 LLM、Copilot、评测三类专题约束。
...
1. 10-repository-physical-reorg/02-app-physical-structure.md
2. 20-code-migration/07-refactor-kickoff.md
3. 20-code-migration/01-infrastructure-migration.md
4. 20-code-migration/03-domain-migration.md
5. 20-code-migration/02-application-migration.md
6. 20-code-migration/06-cutover-batches-and-acceptance.md
7. 30-capability-topics/01-llm-and-retrieval.md
